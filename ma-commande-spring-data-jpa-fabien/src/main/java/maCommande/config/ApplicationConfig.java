...
@Configuration
@ComponentScan("maCommande.dao.jpa") // Indiquer dans quel paquetage scanner pour trouver des annotations
...
@EnableJpaRepositories(basePackages = "maCommande.dao") // Activation des JpaRepository et précision du ou des package(s) impacté(s)
...
//	private String driver;
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(BasicDataSource dataSource) {
		...
		emf.setPackagesToScan("maCommande.model");
