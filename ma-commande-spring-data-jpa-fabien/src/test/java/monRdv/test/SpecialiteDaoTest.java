...
public class SpecialiteDaoTest {
	...
	public void specialite() {
		...
		Optional<Specialite> optSpecialiteFind = specialiteDao.findById(idSpecialite);

		if(!optSpecialiteFind.isPresent()) {
			Assert.fail("Erreur find adresse");
		}
		
		Specialite specialiteFind = optSpecialiteFind.get();
		...
		optSpecialiteFind = specialiteDao.findById(idSpecialite);

		if(!optSpecialiteFind.isPresent()) {
			Assert.fail("Erreur find adresse");
		}
		
		specialiteFind = optSpecialiteFind.get();
