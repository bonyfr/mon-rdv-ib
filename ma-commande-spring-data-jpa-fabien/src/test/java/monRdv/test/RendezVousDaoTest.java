...
public class RendezVousDaoTest {
	...
	public void rendezVous() {
		...
		if(!optRendezVousFind.isPresent()) {
			Assert.fail("Erreur find adresse");
		}
		
		RendezVous rendezVousFind = optRendezVousFind.get();
		...
		optRendezVousFind = rendezVousDao.findById(idRendezVous);

		if(!optRendezVousFind.isPresent()) {
			Assert.fail("Erreur find adresse");
		}
		
		rendezVousFind = optRendezVousFind.get();
